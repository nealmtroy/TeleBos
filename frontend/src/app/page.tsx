        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2">
              <motion.div
                className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary-600 to-primary-900 flex items-center justify-center text-white font-bold text-sm"
                whileHover={{ scale: 1.1, rotate: -5 }}
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                TB
              </motion.div>
              <span className="text-xl font-bold text-gray-900">TeleBos</span>
            </Link>

            {/* Desktop nav */}
            <nav className="hidden md:flex items-center gap-8">
              {[
                { href: "#features", label: _("landing.navFeatures") },
                { href: "#how-it-works", label: _("landing.howItWorks") },
                { href: "/help", label: _("nav.help") },
                { href: "/privacy", label: _("landing.navPrivacy") },
                { href: "/tos", label: _("landing.navTos") },
              ].map((link, i) => (
                <motion.div
                  key={link.href}
              ...
              >
                <Link
                  href="/register"
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium transition shadow-sm"
                >
              ...
              <div className="px-4 py-4 space-y-3">
                ...
                <div className="pt-2 flex items-center gap-3">
                  ...
                  <Link
                    href="/register"
                    onClick={() => setMobileMenu(false)}
                    className="flex-1 text-center py-2 rounded-lg bg-primary-600 text-white text-sm font-medium hover:bg-primary-700"
                  >
                    {_("landing.getStarted")}
                  </Link>
                </div>

        ...
        {tabs.map((t) => (
          <button
            ...
            className={cn(
              ...
              tab === t.id
                ? "bg-white dark:bg-slate-800 text-gray-900 dark:text-slate-100 border border-gray-200/20 dark:border-slate-700"
            ...
            <div key={cat} className="space-y-3">
              ...
              {isExpanded && (
                <div className="grid grid-cols-1 gap-4">
                  {items.map((service) => (
                    <div key={service.id} className="bg-white dark:bg-slate-900/60 border border-gray-200 dark:border-slate-800 rounded-xl p-5 flex flex-col md:flex-row md:items-start justify-between gap-5 hover:border-gray-300 dark:hover:border-slate-700 transition-colors duration-150">
                      <div className="space-y-3 flex-1 min-w-0">
                        {/* Title and ID */}
                        <div className="flex items-start gap-2">
                          <Badge variant="outline" className="text-[11px] font-mono font-bold bg-gray-50 dark:bg-slate-800 text-gray-600 dark:text-slate-300 border-gray-200 dark:border-slate-700 px-1.5 py-0.5 shrink-0 mt-0.5">
                            ID: {service.id}
                          </Badge>
                        ...
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs border-b border-gray-100/50 dark:border-slate-800 pb-3">
                      ...
                      {/* Pricing and Action */}
                      <div className="flex md:flex-col items-center md:items-end justify-between md:justify-start gap-4 md:gap-2 pt-4 md:pt-0 border-t md:border-t-0 border-gray-150 dark:border-slate-800 shrink-0">

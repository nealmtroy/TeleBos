...
export interface Dict {
  ...
  help: {
    ...
    apiHeroDesc: string;
    openDocs: string;
    downloadOpenApi: string;
    secureTitle: string;
    secureDesc: string;
    scopedTitle: string;
    scopedDesc: string;
    versionedTitle: string;
    versionedDesc: string;
  ...
  landing: {
    ...
    proofChat: string;
    proofAutomation: string;
    proofMonitoring: string;
    surfaceIllustrative: string;
    surfaceReady: string;
    surfaceConnected: string;
    surfaceQueued: string;
    surfacePacing: string;
    surfaceDelivered: string;
    surfaceUnread: string;
    surfaceAssigned: string;
    surfaceEnabled: string;
    surfaceMatched: string;
    surfaceRunning: string;
    surfaceComplete: string;
    surfaceAttention: string;
    surfaceAccount: string;
    surfaceTargets: string;
    surfaceDelay: string;
    surfaceProgress: string;
    surfaceRule: string;
    surfaceNextAction: string;
    sculptureAccounts: string;
    sculptureQueue: string;
    sculptureChats: string;
    sculptureRules: string;
    storyProblemKicker: string;
    storyProblemTitle: string;
    storyProblemDesc: string;
    storyProblemPoint1: string;
    storyProblemPoint2: string;
    storyProblemPoint3: string;
    storyConsequenceKicker: string;
    storyConsequenceTitle: string;
    storyConsequenceDesc: string;
    storySolutionKicker: string;
    storySolutionTitle: string;
    storySolutionDesc: string;
    flowKicker: string;
    flowTitle: string;
    flowSubtitle: string;
    flowOverloadTitle: string;
    flowOverloadDesc: string;
    flowFragmentedTitle: string;
    flowFragmentedDesc: string;
    flowControlTitle: string;
    flowControlDesc: string;
    flowAutomatedTitle: string;
    flowAutomatedDesc: string;
    flowActionTitle: string;
    flowActionDesc: string;
    flowNodeAccounts: string;
    flowNodeMessages: string;
    flowNodeAutomation: string;
    flowNodeControl: string;
    flowNodeAction: string;
    flowStatusIncoming: string;
    flowStatusFragmented: string;
    ...
    slabTitle: string;
    slabSubtitle: string;
    slabAccountsTitle: string;
    slabAccountsDesc: string;
    slabBroadcastTitle: string;
    slabBroadcastDesc: string;
    slabChatTitle: string;
    slabChatDesc: string;
    slabAutomationTitle: string;
    slabAutomationDesc: string;
    slabMonitorTitle: string;
    slabMonitorDesc: string;
    slabVisualSignal: string;
    slabVisualControl: string;
    slabVisualVisible: string;
    slabVisualQueue: string;
    slabVisualDelay: string;
    slabVisualDeliver: string;
    slabVisualTrigger: string;
    slabVisualRule: string;
    slabVisualAction: string;
    outcomeAccountsTitle: string;
    outcomeAccountsDesc: string;
    outcomeBroadcastTitle: string;
    outcomeBroadcastDesc: string;
    outcomeVisibilityTitle: string;
    outcomeVisibilityDesc: string;
    capabilitiesTitle: string;
    capabilitiesSubtitle: string;
    capabilityAccountsTitle: string;
    capabilityAccountsDesc: string;
    capabilityAccountsPoint1: string;
    capabilityAccountsPoint2: string;
    capabilityAccountsPoint3: string;
    capabilityBroadcastTitle: string;
    capabilityBroadcastDesc: string;
    capabilityBroadcastPoint1: string;
    capabilityBroadcastPoint2: string;
    capabilityBroadcastPoint3: string;
    capabilityAutomationTitle: string;
    capabilityAutomationDesc: string;
    capabilityAutomationPoint1: string;
    capabilityAutomationPoint2: string;
    capabilityAutomationPoint3: string;
    workflowTitle: string;
    workflowSubtitle: string;
    workflowConnectTitle: string;
    workflowConnectDesc: string;
    workflowConfigureTitle: string;
    workflowConfigureDesc: string;
    workflowOperateTitle: string;
    workflowOperateDesc: string;
    workflowReviewTitle: string;
    workflowReviewDesc: string;
    trustKicker: string;
    trustTitle: string;
    trustDesc: string;
    trustPoint1: string;

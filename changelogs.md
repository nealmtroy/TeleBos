...
- **[b630be07](https://github.com/nealmtroy/TeleBos/commit/b630be07)**: feat(broadcast): migrate to per-cycle log storage with JSONB details
- **[702216b9](https://github.com/nealmtroy/TeleBos/commit/702216b9)**: fix(admin): eliminate Pydantic serialization warning for created_at datetime
...
- **[8ad59434](https://github.com/nealmtroy/TeleBos/commit/8ad59434)**: fix(admin): guard query parameters against non-string defaults in list_admin_auto_replies
- **[9a024b8b](https://github.com/nealmtroy/TeleBos/commit/9a024b8b)**: feat(admin): add Auto-Reply Jobs stats and real-time monitor to admin overview
...
- **[345b0b03](https://github.com/nealmtroy/TeleBos/commit/345b0b03)**: feat: increase accounts page pagination limit to 12 for better desktop responsiveness
...
- **[77854535](https://github.com/nealmtroy/TeleBos/commit/77854535)**: fix(broadcast): resolve logging bot PeerIdInvalidError and optimize groups_channels_sync_loop to prevent Telegram rate limit flood blocks
...
## 2026-07-27
- **[9f23fda6](https://github.com/nealmtroy/TeleBos/commit/9f23fda6)**: fix(marketplace): verify sale profile bio
- **[8250c5bd](https://github.com/nealmtroy/TeleBos/commit/8250c5bd)**: fix(marketplace): brand sale profile names
...
- **[15aa96d2](https://github.com/nealmtroy/TeleBos/commit/15aa96d2)**: fix: resolve sticker download failure by parsing and passing file_reference
...
- **[90a1a3f2](https://github.com/nealmtroy/TeleBos/commit/90a1a3f2)**: feat(chats): implement Web K replication features (right info drawer, left settings menu, custom context menu, emoji picker, and real-time online green dots)
...
## 2026-07-11
- **[2ad59cbb](https://github.com/nealmtroy/TeleBos/commit/2ad59cbb)**: feat: use premium SVG avatars instead of returning 404 for missing profile/chat photos
- **[89097578](https://github.com/nealmtroy/TeleBos/commit/89097578)**: fix(security): validate Origin header on WebSocket endpoints to prevent CSWSH
